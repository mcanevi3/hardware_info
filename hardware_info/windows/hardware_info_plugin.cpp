...
// static
void HardwareInfoPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows *registrar) {
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "hardware_info",
          &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<HardwareInfoPlugin>();
...
HardwareInfoPlugin::HardwareInfoPlugin() {}

HardwareInfoPlugin::~HardwareInfoPlugin() {}

void HardwareInfoPlugin::HandleMethodCall(
